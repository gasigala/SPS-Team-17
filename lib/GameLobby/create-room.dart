...
import 'host-lobby-screen.dart';
import '../Backend/auth.dart';
import 'package:provider/provider.dart';
import '../Backend/User.dart';
import '../Backend/firebase.dart';
import '../Main/screen-slider.dart';
import '../Main/price-buttonbar.dart';
import '../Main/dropdown-category.dart';
                              ...
                              onPressed: () async {
                                if (_formKey.currentState.validate()) {
                                  await DatabaseService(uid: user.uid)
                                    .updateUserData(name ?? userData.name, gamepin ?? userData.gamepin);
