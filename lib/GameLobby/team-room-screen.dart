...
import '../Backend//EnterName.dart';
import '../Backend/auth.dart';
import '../Main/back-button.dart';
import '../Backend/firebase.dart';
import 'package:provider/provider.dart';
import '../Main/info-screen.dart';
          ...
          body: Stack( children: [
            ...
            Container(
              child: TextButton(
                ...
                backgroundColor: Color(0xff04E9CD), primary: Colors.black),
                  child: Text("JOIN"),
                    onPressed: () async {
                      if (_formKey.currentState.validate()) {
                        await DatabaseService(uid: user.uid).updateUserData(name ?? userData.name, gamepin ?? userData.gamepin);
              ...
              RichText(
                text: TextSpan(
                  ...
                  TextStyle(fontSize: 16),
                    children: <TextSpan>[
                      TextSpan(text: 'If you would like to create a game pin click here',
                        style:
                ...
                Flexible(child: Container(
                  child: TextButton(
                    style: TextButton.styleFrom(
                      padding: EdgeInsets.symmetric(horizontal: 114, vertical: 18),
