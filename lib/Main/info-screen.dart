                ...
                children: [
                            ...
                            text: TextSpan(
                              style: TextStyle(fontSize: 45),
                                children: <TextSpan>[
                                  TextSpan(text: 'About',
                                    style: TextStyle(
                                      color: Color(0xff04E9CD), fontWeight: FontWeight.bold)),
                                ]
                            )
                        ),
                      ),
                  ...
                  Padding(
                    ...
                    child: Text('Dining Solo?',
                      style: TextStyle(
                        color: Color(0xff04E9CD), fontSize: 29, fontWeight: FontWeight.bold),
                        textAlign: TextAlign.left,
                    ),
                  ),
                  Padding(
                    padding: const EdgeInsets.all(8.0),
                    child: Text('FoodMates can help you find the perfect bases on your custom needs. FoodMates will present a list of venues in your surrounding area and give you the best match for you. Just adjust your preferences and start swiping!',
                      style: TextStyle(color: Colors.white, fontSize: 18),
                    ),
                  ),
                  Padding(
                  ...
                  Padding(
                    padding: const EdgeInsets.all(8.0),
                    child: Text(
                      ('Are you a local business interested in generating customers?'),
                      style: TextStyle(
                        color: Color(0xff04E9CD),
                        fontSize: 29,
                        fontWeight: FontWeight.bold),
                  ...
                  Padding(
                    ...
                    child: RichText(
                      text: TextSpan(children: [
                        TextSpan(
                          style: TextStyle(color: Colors.white, fontSize: 18),
                            text: 'FoodMates is committed to supporting local businesses. If you would like to add your restaurant to our app it can be done '),
                        TextSpan(
                          text: 'Here',
                          style: TextStyle(color: Colors.blue),
                          recognizer: TapGestureRecognizer()..onTap = () async {
                            const url = "https://googlespsteam17.netlify.app";
